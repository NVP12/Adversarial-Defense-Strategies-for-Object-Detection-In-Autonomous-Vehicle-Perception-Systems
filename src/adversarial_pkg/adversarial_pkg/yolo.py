...
class YOLO(object):
    _defaults = {
        ...
        #--------------------------------------------------------------------------#
        "model_path"        : '/home/manas/adversarial_proj/src/adversarial_pkg/adversarial_pkg/model_data/yolo4_weights.pth',
        "classes_path"      : '/home/manas/adversarial_proj/src/adversarial_pkg/adversarial_pkg/model_data/coco_classes.txt',
        #---------------------------------------------------------------------#
        #   anchors_path代表先验框对应的txt文件，一般不修改。
        #   anchors_mask用于帮助代码找到对应的先验框，一般不修改。
        #---------------------------------------------------------------------#
        "anchors_path"      : '/home/manas/adversarial_proj/src/adversarial_pkg/adversarial_pkg/model_data/yolo_anchors.txt',
    ...
    def detect_image(self, image, crop = False, count = False):
        ...
        #   设置字体与边框厚度
        #---------------------------------------------------------#
        font        = ImageFont.truetype(font='/home/manas/adversarial_proj/src/adversarial_pkg/adversarial_pkg/model_data/simhei.ttf', size=np.floor(3e-2 * image.size[1] + 0.5).astype('int32'))
